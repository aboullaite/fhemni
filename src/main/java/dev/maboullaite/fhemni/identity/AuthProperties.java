...
public record AuthProperties(
    ...
    public record MagicLink(boolean enabled, String baseUrl, String from, Duration lifetime) {
        ...
        public static MagicLink empty() {
            return new MagicLink(false, null, null, Duration.ofMinutes(15));
        }

        public boolean configured() {
            return enabled && baseUrl != null && from != null;
        }
