...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(ElectionCoalitionRateLimitException.class)
    ResponseEntity<ProblemDetail> tooManyCoalitionEvaluations(ElectionCoalitionRateLimitException exception) {
        return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS)
                .header(HttpHeaders.RETRY_AFTER, Long.toString(exception.retryAfterSeconds()))
                .body(problem(HttpStatus.TOO_MANY_REQUESTS, exception.getMessage()));
    }
